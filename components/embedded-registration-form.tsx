...
export function EmbeddedRegistrationForm({
  ...
  // Set the event ID when it changes or when events are loaded
  useEffect(() => {
    if (eventId) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      // Add registration_type as 'embedded'
      const guestData = {
        id: guestId,
        ...values,
        registration_type: "embedded",
        badge_printed: false,
        badge_id: badgeId,
        ...
        <CardHeader className="text-center pb-4">
          {showLogo && (
            <div className="flex justify-center mb-4">
              <Image src="/images/validity-logo.png" alt="Validity Events" width={150} height={40} />
            </div>
          )}
          ...
          <div className="bg-white p-6 rounded-lg border border-yellow-500 shadow-sm w-full max-w-xs mx-auto text-center">
            ...
            <div className="mb-4">
              <div className="mx-auto bg-white p-2 rounded-lg border border-yellow-500 inline-block">
                <div ref={barcodeRef} id="embedded-barcode" className="flex justify-center"></div>
              </div>
            </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="John" {...field} className="border-yellow-500/20 focus:border-yellow-500" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Doe" {...field} className="border-yellow-500/20 focus:border-yellow-500" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
